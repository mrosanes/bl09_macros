...
@macro()
def Flux_macro(self):
    #self.execMacro('umv __DO_NOT_TOUCH_motcalib 5')    with JJ_gap=4
    self.execMacro('umv jj_gap 4')    
    self.execMacro('umv m2_x -1.339')
    #self.execMacro('umv m2_roll 1.556')
    self.execMacro('ascan EnergyCff2.25 300 480 900 1')
    self.execMacro('umv m2_x -1.260')
    #self.execMacro('umv m2_roll 1.548')
    self.execMacro('ascan EnergyCff2.25 480 600 600 1')
    self.execMacro('umv m2_x -1.224')
    self.execMacro('ascan EnergyCff2.25 600 720 600 1')
    self.execMacro('umv m2_x -1.185')
    ...
    self.execMacro('umv EnergyCff2.25 300')
    self.execMacro('umv EnergyCff2.25 300')
    self.execMacro('umv __DO_NOT_TOUCH_motcalib 85')   #with JJ open
    self.execMacro('umv jj_d -11.75')
    self.execMacro('umv jj_u 2.25')  
    self.execMacro('umv m2_x -1.339')
    #self.execMacro('umv m2_roll 1.556')
    self.execMacro('ascan EnergyCff2.25 300 480 900 1')
    self.execMacro('umv m2_x -1.260')
